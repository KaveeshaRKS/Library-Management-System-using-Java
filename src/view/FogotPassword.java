...
public class FogotPassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pwPF2 = new javax.swing.JPasswordField();
        ...
        userNameTF.setFont(new java.awt.Font("Comic Sans MS", 0, 18)); // NOI18N
        ...
        pwPF2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                pwPF2KeyReleased(evt);
            }
        });

        updateBtn.setFont(new java.awt.Font("Comic Sans MS", 0, 18)); // NOI18N
        updateBtn.setForeground(new java.awt.Color(255, 0, 102));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(pwPF1)
                            .addComponent(pwPF2, javax.swing.GroupLayout.DEFAULT_SIZE, 199, Short.MAX_VALUE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(pwPF1, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(pwPF2, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(43, 43, 43)
                .addComponent(updateBtn)
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        if(pwPF1.getText().equals(pwPF2.getText())){
            Dbsearch.searchLoginone(userNameTF.getText(), pwPF1.getText(), pwPF2.getText());
            clearField();
        }else{
    ...
    private void userNameTFKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_userNameTFKeyReleased
        // TODO add your handling code here:
         if(userNameTF.getText().equals("") || pwPF1.getText().equals("") || pwPF2.getText().equals("")){
            updateBtn.setEnabled(false); 
        } else {
    ...
    private void pwPF2KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_pwPF2KeyReleased
        // TODO add your handling code here:
         if(userNameTF.getText().equals("") || pwPF1.getText().equals("") || pwPF2.getText().equals("")){
            updateBtn.setEnabled(false); 
        } else {
    ...
    }//GEN-LAST:event_pwPF2KeyReleased
    ...
    private javax.swing.JPasswordField pwPF2;
